  ...
  return (
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <nav aria-label="Footer navigation"><a href="#collection">Collection</a><a href="#inspiration">Inspiration</a><a href="#our-story">Our story</a><a href="#top">Back to top <span aria-hidden="true">↑</span></a></nav>
      </div>
