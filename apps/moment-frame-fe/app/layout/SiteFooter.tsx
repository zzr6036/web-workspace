    ...
    <footer className="site-footer">
      <div className="footer-main">
        ...
        <nav aria-label="Footer navigation">
          ...
          {/* <a href="https://wa.me/6588467972?text=Hi%20MomentFrame%2C%20I%20have%20a%20question." target="_blank" rel="noreferrer">Message us on WhatsApp</a> */}
          <Link href="/terms">Terms & Conditions</Link><a href="#top">Back to top <span aria-hidden="true">↑</span></a></nav>
      </div>
